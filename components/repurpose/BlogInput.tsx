...
<div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-4">
  <div className="flex items-start space-x-3">
    ...
    <div>
      <h4 className="font-medium text-amber-900 mb-1">Processing Time</h4>
      <p className="text-sm text-amber-800">
        Content analysis typically takes <strong>1-2 minutes</strong>. Please be patient while Marcus analyzes your content and generates LinkedIn-ready ideas.
      </p>
    </div>
  </div>
</div>
